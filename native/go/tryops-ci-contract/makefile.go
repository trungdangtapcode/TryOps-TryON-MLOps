...
func validateMakefile(makefile string) []Check {
	...
	addContains("make_ci_supply_chain_evidence", []string{"supply-chain-sample", "vulnerability-scan-sample", "native-container-contract-sample", "native-dependency-lock-contract-sample", "native-ci-contract-sample", "evaluation-index-sample"})
