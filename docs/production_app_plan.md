...
- [ ] PA063 Dependency lockfile (fix the accelerate/bitsandbytes drift caught in the benchmark run)
...
6. Production profile remaining: PA060 live Vault/workload-identity secret fetch and key-rotation exercise, PA062 live Syft/Trivy/Cosign execution, PA063, PA064 external confirmation, and PA065 external error-tracker DSN exercise.
