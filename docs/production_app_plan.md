...
6. Production profile remaining: PA060 production Kubernetes External Secrets controller sync, PA062 live Syft/Trivy/Cosign execution, PA064 external confirmation, and PA065 external error-tracker DSN exercise.
