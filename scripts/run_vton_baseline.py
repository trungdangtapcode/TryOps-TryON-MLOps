...
from tryops.pipelines.vton_baseline import run_naive_overlay_baseline  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Run the local naive VTON baseline.")
